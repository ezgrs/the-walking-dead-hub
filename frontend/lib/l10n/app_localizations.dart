...
abstract class AppLocalizations {
  ...
  /// No description provided for @homepageMenu.
  ///
  /// In en, this message translates to:
  /// **'Menu'**
  String get homepageMenu;

  /// No description provided for @homepageEntitiesButtonLabel.
  ///
  /// In en, this message translates to:
  /// **'Characters'**
  String get homepageEntitiesButtonLabel;

  /// No description provided for @homepageSeasonsButtonLabel.
  ///
  /// In en, this message translates to:
  /// **'Seasons'**
  String get homepageSeasonsButtonLabel;

  /// No description provided for @homepageEpisodesButtonLabel.
  ///
  /// In en, this message translates to:
  /// **'Episodes'**
  String get homepageEpisodesButtonLabel;
  ...
  /// No description provided for @homepageCreatedByLabel.
  ///
  /// In en, this message translates to:
  /// **'Created by'**
  String get homepageCreatedByLabel;
}
